  ...
  <div class="bigscreen">
    <div class="bigscreen_header">
      <!-- <img
        ...
        alt=""
      /> -->
      <!-- 高生物安全风险车间<br />生物安全关键技术研究数字孪生平台 -->
      <div class="text-my">高风险安全风险车间智能化风险管理和实时动态监管平台<br/>中心侧</div>
...
const address = [{
  left: adaptiveWidth(1080),
  top: adaptiveHeight(630),
  img: JiaoBiao,
  title: "武汉"
}, {
  left: adaptiveWidth(1128),
  top: adaptiveHeight(458),
  img: JiaoBiao,
  title: "北京"
}, {
  left: adaptiveWidth(1270),
  top: adaptiveHeight(390),
  img: JiaoBiao,
  title: "长春"
}]

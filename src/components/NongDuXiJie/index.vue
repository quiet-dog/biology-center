            ...
            <LoopScroll :dataSource="tableList" itemKey="nongDuDataId" direction="up">
                <template v-slot="{ item, index }">
                    <div class="table_box_content_item">
                        ...
                        <span>
                            <el-tooltip :content="item?.particleConcentration" placement="top">
                                <span>{{ item?.particleConcentration }}</span>
                            </el-tooltip>
                        </span>
                        <span>
                            <el-tooltip :content="item?.biologicalConcentration" placement="top">
                                <span>{{ item?.biologicalConcentration }}</span>
                            </el-tooltip>
                        </span>
                        <span>
                            <el-tooltip :content="item?.alarmStatus" placement="top">

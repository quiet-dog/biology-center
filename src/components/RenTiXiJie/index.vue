...
const colors = ["#2C9088","#015598","#69392A"]
...
<template>
    ...
    <div class="table_box">
        ...
        <div class="table_box_content">
            <Vue3SeamlessScroll :key="key" :list="tableList" :direction="'up'" hover>
            ...
            <LoopScroll :dataSource="tableList" itemKey="smDataId" direction="up">
                    ...
                    <div class="table_box_content_item">
                        <div class="personnel_info">
                            <span :style="{
                                ...
                                <el-tooltip :content="item?.personnelName" placement="top">
                                    <span>{{ item?.personnelName }}</span>
                                </el-tooltip>
                            </span>
                            <span>
                                <el-tooltip :content="item?.code" placement="top">
                                    <span>{{ item?.code }}</span>
                                </el-tooltip>
                            </span>
                        </div>

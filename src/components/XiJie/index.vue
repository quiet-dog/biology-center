...
<template>
    ...
    <div class="table_box">
        ...
        <div class="table_box_content">
            <!-- <Vue3SeamlessScroll ref="seamlessScrollRef" :key="key" :list="tableList"  :direction="'up'" hover>
            ...
            <LoopScroll :dataSource="tableList" itemKey="eventId" direction="up">
                <template v-slot="{ item }">
                    <div class="table_box_content_item">
                        <el-tooltip :content="item?.description" placement="top">
                            <span>{{ item?.description }}<br/>

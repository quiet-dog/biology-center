<template>
    ...
    <div class="left_main_box">
        <swiper class="left_main_swiper" direction="vertical" :slides-per-view="3" :slides-per-group="1"
            ...
            <swiper-slide class="left_main_swiper_item" v-for="item in leftConfig">
                <component :is="item.component" :url="item.Url" :address="item.address" :link="item.link" :type="item.type" />
            </swiper-slide>
        </swiper>
    </div>
    ...
    <div class="right_main_box">
        <!--   -->
        <swiper class="right_main_swiper" :modules="[Autoplay]" direction="vertical" :slides-per-view="3"
            ...
            <swiper-slide class="right_main_swiper_item" v-for="item in rightConfig">
                <component :is="item.component" :url="item.Url" :address="item.address" :type="item.type" :link="item.link" />
            </swiper-slide>
        </swiper>
    </div>
</template>
